	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussjiaolianxinxi`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																												...
																																																																												if(this.ruleForm.id){
					await this.$api.update(`discussjiaolianxinxi`, this.ruleForm);
				}else{
					await this.$api.add(`discussjiaolianxinxi`, this.ruleForm);
				}
				uni.setStorageSync('discussjiaolianxinxiCleanType',true);
